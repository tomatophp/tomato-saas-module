...
use Modules\TomatoSaas\App\Console\TomatoSaasInstall;
...
{
    protected string $moduleName = 'TomatoSaaS';

    protected string $moduleNameLower = 'tomato-saas';
